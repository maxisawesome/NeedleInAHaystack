...
import tiktoken
from llmfoundry.models.inference_api_wrapper import FMAPIChatAPIEvalWrapper
from .model import ModelProvider
from transformers import AutoTokenizer


class MosaicML(ModelProvider):
    """
    ...
    def __init__(self,
                 model_name, local, base_url, tokenizer_name, api_key: Optional[str] = None):
        """
    ...
    async def evaluate_model(self, prompt: str) -> str:
        ...
        response = self.model.try_generate_completion(  #
                        messages,
                        num_tokens=self.DEFAULT_MODEL_KWARGS['max_tokens'],
                        generation_kwargs={
